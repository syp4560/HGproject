...
if (navigator.geolocation) {
    ...
    navigator.geolocation.getCurrentPosition(function(position) {
        ...
        var locPosition = new kakao.maps.LatLng(lat, lon), // 마커가 표시될 위치를 geolocation으로 얻어온 좌표로 생성합니다
            message = '<div style="padding:5px;">현재 당신의 위치!</div>'; // 인포윈도우에 표시될 내용입니다
        ...
        // 키워드로 장소를 검색합니다
        ps.keywordSearch('서점', placesSearchCB1, {
            location: new kakao.maps.LatLng(lat, lon),
            radius: 10000,
            sort: kakao.maps.services.SortBy.DISTANCE,
        });

        ps.keywordSearch('도서관', placesSearchCB2, {
            location: new kakao.maps.LatLng(lat, lon),
            radius: 10000,
            sort: kakao.maps.services.SortBy.DISTANCE,
        });
...
function displayMarker_me(locPosition, message) {
    ...
    var imageSrc = './now.png', // 마커이미지의 주소입니다    
    ...
    // 인포윈도우를 생성합니다
    var infowindow_me = new kakao.maps.InfoWindow({
        content : iwContent,
...
function displayMarker(place, imageSrc) {
    ...
    var imageSize = new kakao.maps.Size(30), // 마커이미지의 크기입니다
        imageOption = {offset: new kakao.maps.Point(27, 69)}; // 마커이미지의 옵션입니다. 마커의 좌표와 일치시킬 이미지 안에서의 좌표를 설정합니다.
...
function displayPlaces(places, imageSrc) {
    ...
    for ( var i=0; i<places.length; i++ ) {
        ...
        var placePosition = new kakao.maps.LatLng(places[i].y, places[i].x),
            marker = addMarker(placePosition, i, imageSrc), 
